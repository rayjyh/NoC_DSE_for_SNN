...
# initialize a suitable architecture
while y_b > 100000:
    x1_b = x1 =  choice([1,2])
    x2_b = x2 =  choice([1,2,3,4,5,6,9,11,16])
    x3_b = x3 =  choice([1,3,4,5,6])
...
while T >Tmin:
    ...
    for i in range(k):
        ...
        x1New = functions.choice(x1,[1,2],T)
        x2New = functions.choice(x2,[1,2,3,4,5,6,9,11,16],T)
        x3New = functions.choice(x3,[1,3,4,5,6],T)
        x4New =  functions.choice(x4,[1,2],T)
        x5New =  functions.choice(x5,[1,2,3],T)
        x6New =  functions.choice(x6,[1,2,3,4,5,6],T)
        x7New =  functions.choice(x7,[1,2,3,4,5,6,7],T)
